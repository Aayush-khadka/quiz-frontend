...
//     if (selectedOption && questions[currentQuestionIndex]) {
//       const finalResponseTime = answerTime || 25;
//       submitAnswer(
//         questions[currentQuestionIndex]._id,
//         selectedOption,
//         finalResponseTime
...
//     <div className="min-h-screen bg-gray-50">
//       {/* Fixed Top Header */}
//       <div className="bg-white border-b-4 border-black px-4 py-4 sticky top-0 z-50">
//         <div className="max-w-6xl mx-auto flex items-center justify-between">
//           <div className="flex items-center space-x-4">
//             <div className="bg-black text-white px-4 py-2 border-2 border-black">
//               <h1 className="text-lg font-bold">INQUIZZIT</h1>
//             </div>
//             <div className="hidden sm:block bg-[#A6FAFF] border-2 border-black px-3 py-2">
...
//             {/* Score Display */}
//             <div className="bg-[#B8FF9F] border-2 border-black px-3 py-2">
//               <div className="text-lg font-bold text-black">{score}</div>
//               <div className="text-xs font-medium text-black">PTS</div>
//             </div>
//           </div>
//         </div>
//       </div>
...
//                   </div>
//                   <div
//                     className={`text-3xl font-bold border-2 border-black px-3 py-2 ${
//                       timeLeft <= 5
...
//               {/* Question Content */}
//               <div className="p-6">
//                 <h3 className="text-xl md:text-2xl font-bold text-black text-center mb-8 leading-relaxed">
//                   {currentQuestion.question}
//                 </h3>
...
//                         onClick={() => handleOptionSelect(option)}
//                         disabled={timeLeft === 0 || answerResult}
//                         className={`group p-4 text-left transition-all border-4 border-black text-base min-h-[70px] flex items-center ${buttonClass} ${
//                           timeLeft === 0 || answerResult
//                             ? "cursor-not-allowed"
...
//                 <div
//                   className={`border-4 border-black p-6 ${
//                     answerResult.correct ? "bg-green-100" : "bg-red-100"
//                   }`}
//                 >
//                   <div className="flex flex-col md:flex-row md:items-center md:justify-between">
//                     <div className="flex items-center mb-4 md:mb-0">
...
//                     </div>
//                     {answerResult.correct && (
//                       <div className="bg-green-600 text-white px-4 py-3 text-center border-2 border-black">
...
//                   <div className="text-center py-6">
//                     <div className="text-2xl mb-2">👥</div>
//                     <p className="text-gray-500 text-xs">Loading players...</p>
//                   </div>
//                 )}
//               </div>
//             </div>
